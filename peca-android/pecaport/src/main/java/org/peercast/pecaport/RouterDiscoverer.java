...
/**
 * Androidサービスにバインドされたと同時にInternetGatewayDeviceを検索する。<br>
 *
 * NOTE: research()メソッドを実装するために、ControlPoint#search()をシングルスレッド動作に変えている。
 *
...
public class RouterDiscoverer implements ServiceConnection {
    ...
    private void search(UpnpHeader searchType, int mxSeconds) {
